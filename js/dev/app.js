...
const ruTranslations$1 = {
  ...
  ".footer__text": "Вы можете связаться со мной любым удобным способом",
  ".footer__text--min": "или",
...
const enTranslations$1 = {
  ...
  ".top-page__title:not(.top-page__title--port)": "Rysev Gleb",
  ".top-page__title.top-page__title--port": "Portfolio",
  ".top-page__subtitle": "Front-end Developer",
  ".about__title": "About Me",
  ".about__text p:nth-child(1)": "Hello! I'm Gleb Rysev — Front-end Developer",
  ...
  ".footer__text": "You can contact me in any convenient way",
  ".footer__text--min": "or",
...
function updateLanguage$1(lang) {
  const translation = translations$1[lang];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  languageButtons.forEach((button) => {
    button.addEventListener("click", (e) => {
      ...
      updateLanguage$1(lang);
    });
  });
  const savedLanguage = localStorage.getItem("language") || "ru";
  updateLanguage$1(savedLanguage);
});

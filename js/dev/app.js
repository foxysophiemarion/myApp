...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const homeItem = document.querySelector(".menu__item--home");
  const portfolioItem = document.querySelector(".menu__item--portfolio");
  const logoLink = document.querySelector(".header__logo");
  const menuLogoLink = document.querySelector(".menu__item--logo .menu__link");
  const menuItems = document.querySelectorAll(".menu__list .menu__item:not(.menu__item--home):not(.menu__item--portfolio):not(.menu__item--contacts):not(.menu__item--logo):not(.menu__item--dynamic)");
  if (currentPage === "index.html") {
    ...
    if (homeItem) {
      homeItem.querySelector(".menu__link").setAttribute("href", "index.html#top-page");
    }
    if (logoLink) {
      logoLink.setAttribute("href", "index.html#top-page");
      logoLink.removeAttribute("data-fls-scrollto");
    }
    if (menuLogoLink) {
      menuLogoLink.setAttribute("href", "index.html#top-page");
    }
    menuItems.forEach((item) => {
      const link = item.querySelector(".menu__link");
      const scrollTo = link.getAttribute("data-fls-scrollto");
      if (scrollTo) {
        link.setAttribute("href", `index.html${scrollTo}`);
        link.removeAttribute("data-fls-scrollto");
        link.removeAttribute("data-fls-scrollto-header");
      }
    });
  }
});
...
const ruTranslations = {
  ".menu__link.menu__item--home, .menu__link[href='index.html#top-page']": "Главная",
  ".menu__link[data-fls-scrollto='#about'], .menu__link[href='index.html#about']": "Обо мне",
  ".menu__link[data-fls-scrollto='#skills'], .menu__link[href='index.html#skills']": "Навыки",
  ".menu__link[data-fls-scrollto='#portfolio'], .menu__link[href='index.html#portfolio']": "Портфолио",
  ".menu__link[data-fls-scrollto='#contacts'], .menu__link[href='index.html#contacts']": "Контакты",
  ".header__button": "Обсудить проект",
  ".top-page__title:not(.top-page__title--port)": "Рысьев Глеб",
  ".top-page__title.top-page__title--port": "Портфолио",
  ".top-page__subtitle": "Front-end разработчик",
  ".about__title": "Обо мне",
  ".about__text p:nth-child(1)": "Привет! Я Глеб Рысьев — Front-end разработчик",
  ".about__text p:nth-child(2)": "Мой путь в разработке начался с глубокого интереса к созданию интуитивно понятных интерфейсов и превращения идей в работающие цифровые продукты. Каждый новый проект для меня — это возможность учиться и развиваться, создавая что-то действительно полезное и функциональное.",
  ".about__text p:nth-child(3)": "С августа 2024 года я активно сотрудничаю с компанией <a target='_blank' href='https://seo18.ru/'>SEO технологии Ижевск</a>, где применяю свои навыки для создания качественных веб-решений и развития digital-продуктов. Работа в команде профессионалов помогает мне постоянно совершенствовать свои компетенции и быть в курсе последних тенденций веб-разработки.",
  ".about__text p:nth-child(4)": "Мой подход к работе основан на внимательном изучении требований заказчика и стремлении создать продукт, который будет радовать пользователей своей функциональностью и удобством. Я верю, что качественный код и внимание к деталям — ключ к успешному веб-проекту.",
  ".about__text p:nth-child(5)": "В свободное время увлекаюсь изучением новых технологий и современных подходов в разработке. Считаю, что непрерывное обучение — это основа успеха в нашей динамичной профессии. Также практикую йогу, что помогает поддерживать баланс между работой и личной жизнью. У меня замечательная семья — любимая супруга и две прекрасные дочери, которые вдохновляют меня на новые свершения.",
  ".about__text p:nth-child(6)": "Готов воплощать ваши идеи в качественные веб-решения и создавать продукты, которые будут радовать пользователей своей функциональностью и стильным дизайном.",
  ".skills__title": "Ключевые навыки",
  ".portfolio__title": "Портфолио",
  ".portfolio__button": "Посмотреть все",
  ".portfolio--page .top-page__title": "Портфолио",
  ".portfolio__item:nth-child(1) .item-portfolio__title": "Производство вагон-домов",
  ".portfolio__item:nth-child(2) .item-portfolio__title": "Фитнес клуб X-FIT",
  ".portfolio__item:nth-child(3) .item-portfolio__title": "Группа компаний UFK-Group",
  ".portfolio__item:nth-child(4) .item-portfolio__title": "UFK-Cayman",
  ".portfolio__item:nth-child(5) .item-portfolio__title": "Производство и поставка дров",
  ".portfolio__item:nth-child(6) .item-portfolio__title": "Продажа стройматериалов",
  ".portfolio__item:nth-child(7) .item-portfolio__title": "Реабилитационный центр",
  ".portfolio__item:nth-child(8) .item-portfolio__title": "Производственное объединение ПТМ",
  ".portfolio__item:nth-child(9) .item-portfolio__title": "Юридический центр",
  ".portfolio__item:nth-child(10) .item-portfolio__title": "Продажа электроники",
  ".portfolio__item:nth-child(11) .item-portfolio__title": "Строительные услуги",
  ".portfolio__item:nth-child(12) .item-portfolio__title": "Водородная компания",
  ".portfolio__item:nth-child(13) .item-portfolio__title": "Средства для чистки",
  ".portfolio__item:nth-child(14) .item-portfolio__title": "Организация питания",
  ".portfolio__item:nth-child(15) .item-portfolio__title": "Производство и продажа сыпучих материалов",
  ".portfolio__item:nth-child(16) .item-portfolio__title": "Продажа стройматериалов и электроники",
  ".portfolio__item:nth-child(17) .item-portfolio__title": "Продажа электроники",
  ".portfolio__item:nth-child(18) .item-portfolio__title": "Продажа стройматериалов",
  ".footer__title": "Контакты",
  ".footer__text:nth-child(1)": "Вы можете связаться со мной любым удобным способом",
  ".footer__text:nth-child(3)": "или",
  ".footer__button": "Оставить заявку",
  ".bottom-footer__offerta": "Данный сайт является личным портфолио и содержит информацию о профессиональной деятельности. Все предложения об оказании услуг являются предварительными и требуют подтверждения в рамках официального договора",
  ".bottom-footer__privacy": "Политика конфиденциальности",
  ".bottom-footer__copy": "Copyright © 2025 Глеб Рысьев",
  ".form-feedback__title": "Оставить заявку",
  ".form-feedback__body input[placeholder='Имя']": "Имя",
  ".form-feedback__body input[placeholder='E-mail*']": "E-mail*",
  ".form-feedback__body input[placeholder='Номер телефона*']": "Номер телефона*",
  ".form-feedback__body textarea[placeholder='Требуемая услуга']": "Требуемая услуга",
  ".checkbox__text": "Нажимая кнопку, я даю согласие на обработку персональных данных, а также подтверждаю, что ознакомлен с Политикой конфиденциальности",
  ".form-feedback__button": "Отправить"
};
const enTranslations = {
  ".menu__link.menu__item--home, .menu__link[href='index.html#top-page']": "Home",
  ".menu__link[data-fls-scrollto='#about'], .menu__link[href='index.html#about']": "About Me",
  ".menu__link[data-fls-scrollto='#skills'], .menu__link[href='index.html#skills']": "Skills",
  ".menu__link[data-fls-scrollto='#portfolio'], .menu__link[href='index.html#portfolio']": "Portfolio",
  ".menu__link[data-fls-scrollto='#contacts'], .menu__link[href='index.html#contacts']": "Contacts",
  ".header__button": "Discuss a Project",
  ".top-page__title:not(.top-page__title--port)": "Rysyev Gleb",
  ".top-page__title.top-page__title--port": "Portfolio",
  ".top-page__subtitle": "Front-end Developer",
  ".about__title": "About Me",
  ".about__text p:nth-child(1)": "Hello! I'm Gleb Rysyev — Front-end Developer",
  ".about__text p:nth-child(2)": "My journey in development began with a deep interest in creating intuitive interfaces and turning ideas into functional digital products. Each new project is an opportunity for me to learn and grow, creating something truly useful and effective.",
  ".about__text p:nth-child(3)": "Since August 2024, I have been actively collaborating with <a target='_blank' href='https://seo18.ru/'>SEO Technologies Izhevsk</a>, where I apply my skills to create high-quality web solutions and develop digital products. Working with a team of professionals helps me continuously improve my expertise and stay updated with the latest trends in web development.",
  ".about__text p:nth-child(4)": "My approach to work is based on carefully studying the client's requirements and striving to create a product that delights users with its functionality and usability. I believe that quality code and attention to detail are the keys to a successful web project.",
  ".about__text p:nth-child(5)": "In my free time, I enjoy exploring new technologies and modern approaches to development. I believe that continuous learning is the foundation of success in our dynamic profession. I also practice yoga, which helps me maintain a balance between work and personal life. I have a wonderful family — a beloved wife and two amazing daughters who inspire me to achieve new heights.",
  ".about__text p:nth-child(6)": "I am ready to bring your ideas to life with high-quality web solutions and create products that delight users with their functionality and stylish design.",
  ".skills__title": "Key Skills",
  ".portfolio__title": "Portfolio",
  ".portfolio__button": "View All",
  ".portfolio--page .top-page__title": "Portfolio",
  ".portfolio__item:nth-child(1) .item-portfolio__title": "Manufacture of Mobile Homes",
  ".portfolio__item:nth-child(2) .item-portfolio__title": "X-FIT Fitness Club",
  ".portfolio__item:nth-child(3) .item-portfolio__title": "UFK-Group Companies",
  ".portfolio__item:nth-child(4) .item-portfolio__title": "UFK-Cayman",
  ".portfolio__item:nth-child(5) .item-portfolio__title": "Firewood Production and Supply",
  ".portfolio__item:nth-child(6) .item-portfolio__title": "Construction Materials Sales",
  ".portfolio__item:nth-child(7) .item-portfolio__title": "Rehabilitation Center",
  ".portfolio__item:nth-child(8) .item-portfolio__title": "PTM Manufacturing Association",
  ".portfolio__item:nth-child(9) .item-portfolio__title": "Legal Center",
  ".portfolio__item:nth-child(10) .item-portfolio__title": "Electronics Sales",
  ".portfolio__item:nth-child(11) .item-portfolio__title": "Construction Services",
  ".portfolio__item:nth-child(12) .item-portfolio__title": "Hydrogen Company",
  ".portfolio__item:nth-child(13) .item-portfolio__title": "Cleaning Products",
  ".portfolio__item:nth-child(14) .item-portfolio__title": "Catering Organization",
  ".portfolio__item:nth-child(15) .item-portfolio__title": "Production and Sale of Bulk Materials",
  ".portfolio__item:nth-child(16) .item-portfolio__title": "Construction Materials and Electronics Sales",
  ".portfolio__item:nth-child(17) .item-portfolio__title": "Electronics Sales",
  ".portfolio__item:nth-child(18) .item-portfolio__title": "Construction Materials Sales",
  ".footer__title": "Contacts",
  ".footer__text:nth-child(1)": "You can contact me in any convenient way",
  ".footer__text:nth-child(3)": "or",
  ".footer__button": "Leave a Request",
  ".bottom-footer__offerta": "This website is a personal portfolio and contains information about professional activities. All service offers are preliminary and require confirmation within the framework of an official contract.",
  ".bottom-footer__privacy": "Privacy Policy",
  ".bottom-footer__copy": "Copyright © 2025 Gleb Rysyev",
  ".form-feedback__title": "Leave a Request",
  ".form-feedback__body input[placeholder='Имя']": "Name",
  ".form-feedback__body input[placeholder='E-mail*']": "E-mail*",
  ".form-feedback__body input[placeholder='Номер телефона*']": "Phone Number*",
  ".form-feedback__body textarea[placeholder='Требуемая услуга']": "Required Service",
  ".checkbox__text": "By clicking the button, I consent to the processing of personal data and confirm that I have read the Privacy Policy",
...
function updateLanguage(lang) {
  ...
  Object.keys(translation).forEach((selector) => {
    const elements = document.querySelectorAll(selector);
    elements.forEach((element) => {
      if (selector.includes(".about__text p")) {
        element.innerHTML = translation[selector];
      } else if (element.tagName === "INPUT" || element.tagName === "TEXTAREA") {
        element.placeholder = translation[selector];
      } else {
        element.textContent = translation[selector];
      }
    });
  });
  if (typeof Swiper !== "undefined" && document.querySelector(".portfolio__slider")) {
    const swiper = document.querySelector(".portfolio__slider").swiper;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (currentPage === "index.html") {
    ...
    if (homeItem) homeItem.querySelector(".menu__link").setAttribute("href", "index.html#top-page");
    if (logoLink) {
      logoLink.setAttribute("href", "index.html#top-page");
      logoLink.removeAttribute("data-fls-scrollto");
    }
    if (menuLogoLink) menuLogoLink.setAttribute("href", "index.html#top-page");
    menuItems.forEach((item) => {
      const link = item.querySelector(".menu__link");
      const scrollTo = link.getAttribute("data-fls-scrollto");
      if (scrollTo) {
